      ...
      <div className="relative w-full max-w-md bg-black/30 backdrop-blur-2xl rounded-3xl shadow-2xl overflow-hidden border border-emerald-500/20">
        ...
        <div className="relative p-8">
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl mb-4 shadow-2xl shadow-emerald-500/50">
              <svg
                className="w-10 h-10 text-[#FFFFF0] animate-pulse"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <h1 className="text-4xl font-extrabold text-[#FFFFF0] tracking-tight">
              {isLogin ? "Club Haven" : "Join Club Haven"}
            </h1>
            <p className="mt-2 text-[#FFFFF0]/80 text-base">
              {isLogin ? "Welcome back to luxury" : "Become an exclusive member"}
            </p>
          </div>

          {error && (
            <p className="mb-4 text-sm text-red-300 bg-red-900/40 px-3 py-2 rounded-lg border border-red-500/40">
              {error}
            </p>
          )}
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            {!isLogin && (
              <div className="animate-slideIn">
                <label className="block text-sm font-semibold text-[#FFFFF0]/90 mb-2">
                  Full Name
                </label>
                <div
                ...
                >
                  ...
                  <svg
                    className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#FFFFF0]/60 group-focus-within:text-emerald-400 transition"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  {showPassword ? (
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L6.95 6.95m2.928 2.928L6.95 6.95m2.928 2.928l4.242-4.242"
                      />
                    </svg>
                  ) : (
                    <svg
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-5 mt-8 bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-600 text-[#FFFFF0] font-bold text-lg rounded-xl shadow-lg shadow-emerald-500/50 transform transition-all hover:scale-105 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {loading
                ? isLogin
                  ? "Entering..."
